...
public class Torneira {
    ...
    private List<String> torneira = new ArrayList<String>();



    public Torneira()  {String topic = ADAFRUIT_USERNAME + "/feeds/torneira";
        ...
        try {
            ...
            MqttClient mqtt_client = new MqttClient("tcp://io.adafruit.com:1883", "Tor",persistence);
            MqttCallback callback = new MqttCallback() {
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    if(message.equals("reset"))
                        torneira = new ArrayList<>();
                    torneira.add(message.toString());
                    System.out.println(torneira.size());
                }
